...
$rootScope.App.ID = "com.appbuilder.admob";
$rootScope.App.Name = "AdMob (Created with an unregistered version of DecSoft's App Builder)";
$rootScope.App.ShortName = "AdMob";
...
$rootScope.EventsTextarea = {};
$rootScope.EventsTextarea.ABRole = 9001;
$rootScope.EventsTextarea.Hidden = "";
$rootScope.EventsTextarea.Value = "";
$rootScope.EventsTextarea.Title = "";
$rootScope.EventsTextarea.TabIndex = -1;
$rootScope.EventsTextarea.TooltipText = "";
$rootScope.EventsTextarea.TooltipPos = "top";
$rootScope.EventsTextarea.PopoverText = "";
$rootScope.EventsTextarea.PopoverEvent = "mouseenter";
$rootScope.EventsTextarea.PopoverTitle = "";
$rootScope.EventsTextarea.PopoverPos = "top";
$rootScope.EventsTextarea.PlaceHolder = "";
$rootScope.EventsTextarea.Class = "form-control form-control-md ";
$rootScope.EventsTextarea.Disabled = "";
$rootScope.EventsTextarea.ReadOnly = "true";
...
$rootScope.Button1.Text = "Show banner";
...
$rootScope.Button2.Text = "Show interstitial";
$rootScope.Button2.Class = "btn btn-success btn-md ";
...
$rootScope.Button3.Text = "Hide banner";
$rootScope.Button3.Class = "btn btn-warning btn-md ";
...
$rootScope.Button4.Text = "Clear log";
$rootScope.Button4.Class = "btn btn-info btn-md ";
...
$scope.alertBox("The AdMob plugin is not available here!", "warning");
...
window.App.Plugins.AdMob.call().AdMobShowBanner("ca-app-pub-5672383893086848/8393039120", "TOP_CENTER", "SMART_BANNER", "true");
...
window.App.Plugins.AdMob.call().AdMobShowInterstitial("ca-app-pub-5672383893086848/2346505521", "true");
